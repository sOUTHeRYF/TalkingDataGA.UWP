	...
	internal sealed class DeflateManager
	{
			...
			for (int i = 0; i <= max_code; i++)
			{
				...
				if (++num3 >= num4 || num6 != num2)
				{
					...
					else if (num6 != 0)
					{
						if (num6 != num)
						{
							short[] expr_84_cp_0 = this.bl_tree;
							int expr_84_cp_1 = num6 * 2;
							expr_84_cp_0[expr_84_cp_1] += 1;
						}
						short[] expr_9C_cp_0 = this.bl_tree;
						int expr_9C_cp_1 = InternalConstants.REP_3_6 * 2;
						expr_9C_cp_0[expr_9C_cp_1] += 1;
					}
					else if (num3 <= 10)
					{
						short[] expr_BC_cp_0 = this.bl_tree;
						int expr_BC_cp_1 = InternalConstants.REPZ_3_10 * 2;
						expr_BC_cp_0[expr_BC_cp_1] += 1;
					}
					else
					{
						short[] expr_D6_cp_0 = this.bl_tree;
						int expr_D6_cp_1 = InternalConstants.REPZ_11_138 * 2;
						expr_D6_cp_0[expr_D6_cp_1] += 1;
					}
					num3 = 0;
					num = num6;
					if (num2 == 0)
		...
		internal void send_bits(int value, int length)
		{
			if (this.bi_valid > DeflateManager.Buf_size - length)
			{
				...
				byte[] arg_52_0 = this.pending;
				int num = this.pendingCount;
				this.pendingCount = num + 1;
				arg_52_0[num] = (byte)this.bi_buf;
				byte[] arg_73_0 = this.pending;
				num = this.pendingCount;
				this.pendingCount = num + 1;
				arg_73_0[num] = (byte)(this.bi_buf >> 8);
		...
		internal bool _tr_tally(int dist, int lc)
		{
			...
			else
			{
				this.matches++;
				dist--;
				short[] expr_A0_cp_0 = this.dyn_ltree;
				int expr_A0_cp_1 = ((int)Tree.LengthCode[lc] + InternalConstants.LITERALS + 1) * 2;
				expr_A0_cp_0[expr_A0_cp_1] += 1;
				short[] expr_B9_cp_0 = this.dyn_dtree;
				int expr_B9_cp_1 = Tree.DistanceCode(dist) * 2;
		...
		internal void bi_flush()
		{
			if (this.bi_valid == 16)
			{
				byte[] arg_28_0 = this.pending;
				int num = this.pendingCount;
				this.pendingCount = num + 1;
				arg_28_0[num] = (byte)this.bi_buf;
				byte[] arg_49_0 = this.pending;
				num = this.pendingCount;
				this.pendingCount = num + 1;
				arg_49_0[num] = (byte)(this.bi_buf >> 8);
				this.bi_buf = 0;
				this.bi_valid = 0;
				return;
			}
			if (this.bi_valid >= 8)
			{
				byte[] arg_80_0 = this.pending;
				int num = this.pendingCount;
				this.pendingCount = num + 1;
				arg_80_0[num] = (byte)this.bi_buf;
		...
		internal void bi_windup()
		{
			if (this.bi_valid > 8)
			{
				byte[] arg_27_0 = this.pending;
				int num = this.pendingCount;
				this.pendingCount = num + 1;
				arg_27_0[num] = (byte)this.bi_buf;
				byte[] arg_48_0 = this.pending;
				num = this.pendingCount;
				this.pendingCount = num + 1;
				arg_48_0[num] = (byte)(this.bi_buf >> 8);
			}
			else if (this.bi_valid > 0)
			{
				byte[] arg_72_0 = this.pending;
				int num = this.pendingCount;
				this.pendingCount = num + 1;
				arg_72_0[num] = (byte)this.bi_buf;
			}
			this.bi_buf = 0;
			this.bi_valid = 0;
		}
		...
		internal void copy_block(int buf, int len, bool header)
		{
			...
			if (header)
			{
				byte[] arg_29_0 = this.pending;
				int num = this.pendingCount;
				this.pendingCount = num + 1;
				arg_29_0[num] = (byte)len;
				byte[] arg_45_0 = this.pending;
				num = this.pendingCount;
				this.pendingCount = num + 1;
				arg_45_0[num] = (byte)(len >> 8);
				byte[] arg_60_0 = this.pending;
				num = this.pendingCount;
				this.pendingCount = num + 1;
				arg_60_0[num] = (byte)(~(byte)len);
				byte[] arg_7D_0 = this.pending;
				num = this.pendingCount;
				this.pendingCount = num + 1;
				arg_7D_0[num] = (byte)(~len >> 8);
			}
		...
		internal int Deflate(FlushType flush)
		{
			...
			if (this.status == DeflateManager.INIT_STATE)
			{
				...
				byte[] arg_11D_0 = this.pending;
				num4 = this.pendingCount;
				this.pendingCount = num4 + 1;
				arg_11D_0[num4] = (byte)(num2 >> 8);
				byte[] arg_137_0 = this.pending;
				num4 = this.pendingCount;
				this.pendingCount = num4 + 1;
				arg_137_0[num4] = (byte)num2;
				if (this.strstart != 0)
				{
					byte[] arg_16F_0 = this.pending;
					num4 = this.pendingCount;
					this.pendingCount = num4 + 1;
					arg_16F_0[num4] = (byte)((this._codec._Adler32 & 4278190080u) >> 24);
					byte[] arg_19C_0 = this.pending;
					num4 = this.pendingCount;
					this.pendingCount = num4 + 1;
					arg_19C_0[num4] = (byte)((this._codec._Adler32 & 16711680u) >> 16);
					byte[] arg_1C8_0 = this.pending;
					num4 = this.pendingCount;
					this.pendingCount = num4 + 1;
					arg_1C8_0[num4] = (byte)((this._codec._Adler32 & 65280u) >> 8);
					byte[] arg_1F2_0 = this.pending;
					num4 = this.pendingCount;
					this.pendingCount = num4 + 1;
					arg_1F2_0[num4] = (byte)(this._codec._Adler32 & 255u);
				}
				this._codec._Adler32 = Adler.Adler32(0u, null, 0, 0);
			}
			...
			byte[] arg_38D_0 = this.pending;
			num4 = this.pendingCount;
			this.pendingCount = num4 + 1;
			arg_38D_0[num4] = (byte)((this._codec._Adler32 & 4278190080u) >> 24);
			byte[] arg_3BA_0 = this.pending;
			num4 = this.pendingCount;
			this.pendingCount = num4 + 1;
			arg_3BA_0[num4] = (byte)((this._codec._Adler32 & 16711680u) >> 16);
			byte[] arg_3E6_0 = this.pending;
			num4 = this.pendingCount;
			this.pendingCount = num4 + 1;
			arg_3E6_0[num4] = (byte)((this._codec._Adler32 & 65280u) >> 8);
			byte[] arg_410_0 = this.pending;
			num4 = this.pendingCount;
			this.pendingCount = num4 + 1;
			arg_410_0[num4] = (byte)(this._codec._Adler32 & 255u);
			this._codec.flush_pending();
